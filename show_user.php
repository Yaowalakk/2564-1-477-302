<?php
    ...
    if (isset($_GET['user_id'])) {
        $sql = "DELETE FROW users where user_id =" . $_GET['user_id']; 
     	...
     	<div class="collapse navbar-collapse" id="navbar1">
     		<ul class="nav navbar-nav navbar-right">
                 ...
                 <?php if (isset($_SESSION['name'])) ?>
                    <!-- true -->
                    <li><p class="navbar-text">Signed in as <?php $_SESSION['name']; ?></p></li>
 ...
 <div class="container">
     <div class="row">
         <div class="col-xs-8 col-xs-offset-2">
            ...
            <div>
            <?php echo mysqli_num_rows($result) . " rocord(s) found."; ?></div>
